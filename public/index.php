...
<head>
    ...
    <meta name="description" content="GM University's premier platform for internships, placements, AI interview prep, and career development.">
    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        html { scroll-behavior: auto; } /* let Lenis handle this */
        ...
        @keyframes pulse {
            0%, 100% { box-shadow: 0 0 7px rgba(212,175,55,0.7); }
        ...
        .nav__demo:hover { color: var(--white); }
        ...
        .nav__mobile-menu a:hover { color: var(--white); background: rgba(255,255,255,0.05); }
        ...
        .nav__mobile-menu .mobile-cta:hover { background: var(--gold-light); }

        /* Mobile: show hamburger, hide desktop links */
        @media (max-width: 768px) {
            .nav { top: 12px; padding: 0 16px; }
            .nav__links, .nav__demo, .nav__sep { display: none; }
            .nav__toggle { display: flex; }
            .nav__pill { padding: 0 6px 0 16px; }
        }
        ...
        .stat.in-view .stat__bar { width: 100%; }
        ...
        @media (max-width: 1024px) {
            .stats__top { padding: 60px 40px 40px; }
            .stat { padding: 40px 28px; }
            .stat__number { font-size: clamp(2.4rem, 4vw, 4rem); }
        }

        @media (max-width: 600px) {
            .stats__top { flex-direction: column; padding: 40px 20px 28px; }
            .stats__headline { font-size: 1.8rem; }
            .stat { padding: 28px 16px; }
            .stat__number { font-size: 2rem; }
            .stat__label { font-size: 0.6rem; letter-spacing: 0.08em; }
        }
        ...
        .fc--dark::before, .fc--maroon::before, .fc--gold::before, .fc--wide::before {
            content: '';
            position: absolute;
            inset: 0;
        ...
        .fc--light .fc__visual { opacity: 0.1; color: var(--text); }
        .fc--dark .fc__visual, .fc--maroon .fc__visual { color: var(--white); }
        .fc--gold .fc__visual { color: var(--gold); opacity: 0.2; }
        ...
        .fc--dark .fc__chip, .fc--maroon .fc__chip, .fc--wide .fc__chip {
            background: rgba(255,255,255,0.08);
        ...
        .fc--dark .fc__title, .fc--maroon .fc__title,
        .fc--gold .fc__title, .fc--wide .fc__title { color: var(--white); }

        .fc--light .fc__title { color: var(--text); }
        ...
        .fc--dark .fc__desc, .fc--maroon .fc__desc,
        .fc--gold .fc__desc, .fc--wide .fc__desc { color: rgba(255,255,255,0.5); }

        .fc--light .fc__desc { color: var(--text-muted); }

        /* Gold accent line on light card */
        .fc--light:hover { border-color: var(--gold); }
        ...
        .fc--wide .fc__left { flex: 0 0 auto; }
        .fc--wide .fc__right { flex: 1; }
        ...
        @media (max-width: 1024px) {
            ...
            .fc:nth-child(1) { grid-column: span 4; }
            .fc:nth-child(2) { grid-column: span 4; }
            .fc:nth-child(3) { grid-column: span 2; }
            .fc:nth-child(4) { grid-column: span 2; }
            .fc:nth-child(5) { grid-column: span 2; }
            .fc:nth-child(6) { grid-column: span 2; }
        }

        @media (max-width: 768px) {
            .features { padding: 80px 24px; }
            .features__grid { grid-template-columns: 1fr; gap: 14px; }
            .fc:nth-child(n) { grid-column: span 1; }
            .fc { min-height: 220px; }
            .fc--wide { padding: 40px 32px; min-height: 180px; }
            .fc--wide .fc__inner { gap: 30px; }
        }
        ...
        .story__scroll-space { height: 400vh; }

        /* Mobile story */
        @media (max-width: 768px) {
            .story__sticky { grid-template-columns: 1fr; }
            .story__left { display: none; }
            .story__right { padding: 40px 24px; }
            .story__step { padding: 40px 24px; }
            .story__step-title { font-size: 2.2rem; }
        ...
        .footer__bottom .footer__gold { color: var(--gold); font-weight: 600; }
        ...
        .gsap-up-sm   { opacity: 0; transform: translateY(30px); }
        ...
        @media (max-width: 1024px) {
            ...
            .stat:first-child { border-radius: var(--radius-md) 0 0 0; }
            .stat:last-child  { border-radius: 0 0 var(--radius-md) 0; }
            .stat:nth-child(2){ border-radius: 0 var(--radius-md) 0 0; }
        ...
        @media (max-width: 768px) {
            ...
            .stats__inner { grid-template-columns: 1fr 1fr; gap: 2px; }
            ...
            .story__dots { right: 16px; }
            .story__step-title { font-size: 2rem; }
        }

        @media (max-width: 480px) {
            .stats__inner { grid-template-columns: 1fr; gap: 2px; }
            .stat:first-child { border-radius: var(--radius-sm) var(--radius-sm) 0 0; }
            .stat:last-child  { border-radius: 0 0 var(--radius-sm) var(--radius-sm); }
            .stat:nth-child(2), .stat:nth-child(3) { border-radius: 0; }
    ...
    <div class="stats__inner">
        ...
        <div class="stats__top">
            ...
            <p class="stats__intro gsap-up">
                LAKSHYA has helped thousands of GM University students land their dream roles at India's top companies.
            </p>
        </div>
...
<section class="features" id="features">
    <div class="features__header">
        ...
        <p class="section-sub gsap-up">A complete career toolkit built for GM University students — from prep to placement.</p>
    </div>
    ...
    <div class="features__grid" id="featuresGrid">
        ...
        <div class="fc fc--dark gsap-up">
            ...
            <p class="fc__desc">Practice with our AI trained on 500+ real placement patterns. Get instant, honest feedback on every answer — available 24/7.</p>
        </div>
        ...
        <div class="fc fc--maroon gsap-up">
            ...
            <p class="fc__desc">Company-specific aptitude, verbal, and reasoning tests. Difficulty adjusts in real time so you're always challenged correctly.</p>
        </div>
        ...
        <div class="fc fc--light gsap-up">
            ...
            <p class="fc__desc">See exactly where you stand — readiness score, weak areas, and improvement over time.</p>
        </div>
        ...
        <div class="fc fc--gold gsap-up">
            ...
            <p class="fc__desc">AI-curated learning paths built for your target role. No guesswork, just a clear plan.</p>
        </div>
        ...
        <div class="fc fc--wide gsap-up">
            <div class="fc__inner">
                ...
                <div class="fc__right">
                    ...
                    <h3 class="fc__title" style="font-size:clamp(1.4rem,3vw,2.2rem);">Resume Builder & Portfolio Sync</h3>
                    <p class="fc__desc">Create a professional resume in minutes. Projects and certifications sync automatically — no copy-paste needed.</p>
                </div>
            </div>
        </div>
    ...
    <div class="story__sticky" id="storySticky">
        ...
        <div class="story__right" id="storyRight">
            ...
            <div class="story__step" id="step-0">
                ...
                <p class="story__step-text">Sign up with your university credentials. Your academic data, skills, and portfolio sync automatically — no manual setup required.</p>
            </div>
            ...
            <div class="story__step" id="step-1">
                ...
                <p class="story__step-text">Practice aptitude tests and mock interviews powered by real company patterns. Our AI gives you honest, constructive feedback after every session.</p>
            </div>
            ...
            <div class="story__step" id="step-2">
                ...
                <p class="story__step-text">Browse curated opportunities matched to your placement score and skill profile. Apply in one click — your resume is ready and waiting.</p>
            </div>
            ...
            <div class="story__step" id="step-3">
                ...
                <p class="story__step-text">Track every application, get interview reminders, and celebrate your placement. We'll be there every step of the way.</p>
            </div>
    ...
    <div class="footer__inner">
        <div class="footer__top">
            <div>
                ...
                <p class="footer__brand-sub">GM University's comprehensive Internship and Placement Portal. Empowering students to achieve their career goals.</p>
            </div>
