<?php
/**
 * Global Admin - Student Feedback Review Page
 */
    ...
    if ($action === 'submit_reply') {
        ...
        if ($csrfToken !== ($_SESSION['csrf_token'] ?? '')) {
            ...
            try {
                ...
                $stmt->execute([$replyText, $fullName . ' (Admin)', $feedbackId]);
        ...
        <div class="panel">
            <div class="panel-header">
                <div class="panel-title">
                    <i class="fas fa-list" style="color: var(--primary-maroon);"></i> Submissions List
                </div>
