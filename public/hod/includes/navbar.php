    ...
    <div class="nav-left">
        <a href="dashboard.php" class="nav-brand">
            ...
            <div class="brand-text">
                <span class="brand-title">HOD Portal</span>
                <span class="brand-subtitle"><?php echo htmlspecialchars($department ?: 'Central'); ?></span>
            </div>
        </a>
        ...
        <ul class="nav-items">
            ...
            <li>
                <a href="ai_monitor.php" class="nav-link <?php echo $currentPage == 'ai_monitor.php' ? 'active' : ''; ?>">
    ...
    <div class="nav-right">
        <div class="user-profile">
            <div class="user-info">
                ...
                <span class="user-dept">HOD - <?php echo htmlspecialchars($department); ?></span>
            </div>
